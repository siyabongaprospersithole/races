...
.accordion-gradient .accordion__body {
                ...
                <div class="py-5">
                  ...
                  <div data-kt-search-element="empty" class="text-center d-none">
                    ...
                    <div class="text-center px-5">
                      <img src="<?php echo e(asset('assets/media/illustrations/sketchy-1/1.png')); ?>" alt="" class="w-100 h-200px h-sm-325px" />
                    </div>
                    <!--end::Illustration-->
                  </div>
                  <!--end::Empty-->
  ...
  <!--end::Body-->
</html><?php /**PATH C:\xampp\Workspace\personalidmanagement\resources\views/welcome.blade.php ENDPATH**/ ?>